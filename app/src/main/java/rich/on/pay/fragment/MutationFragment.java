...
import rich.on.pay.adapter.MutationAdapter;
import rich.on.pay.base.BaseFragment;
import rich.on.pay.model.TransactionOrderDetail;
import rich.on.pay.utils.Extension;

import static rich.on.pay.activity.MutationActivity.TYPE_BALANCE;
import static rich.on.pay.activity.MutationActivity.TYPE_BONUS_PENDING;
import static rich.on.pay.activity.MutationActivity.TYPE_BONUS_SUCCESS;
